## Repo
https://github.com/TanapatPluemchai/ESP32-Web-Server
## web
![image](https://github.com/TanapatPluemchai/ESP32-Web-Server/assets/115067806/1fe519d4-f73e-490d-b24b-8ad13979fa18)
## Terminal output
```css
entry 0x40080698
...
I (7982) esp_netif_handlers: example_connect: sta ip: 192.168.1.43, mask: 255.255.255.0, gw: 192.168.1.1
I (7982) example_connect: Got IPv4 event: Interface "example_connect: sta" address: 192.168.1.43
...
I (21552) example: Found header => Host: 192.168.1.43
